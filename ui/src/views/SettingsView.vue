  ...
  <div class="p-6 relative overflow-hidden">
    ...
    <div class="mb-8 relative">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-base-content/60 mt-2 text-lg">{{ t.settings.description }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="card glass gradient-border hover:glow-primary transition-all duration-300">
        <div class="card-body">
          <div class="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 class="text-xl font-semibold text-gradient">{{ t.settings.language }}</h2>
              <p class="text-sm text-base-content/60">{{ t.settings.selectLanguage }}</p>
            </div>
          </div>
          <LanguageSelector />
        </div>
      ...
      <div class="card glass gradient-border hover:glow-secondary transition-all duration-300">
        <div class="card-body">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-12 h-12 rounded-xl bg-secondary/10 flex items-center justify-center glow-secondary">
            ...
            <div>
              <h2 class="text-xl font-semibold text-gradient-warm">{{ t.settings.theme }}</h2>
              <p class="text-sm text-base-content/60">Toggle light or dark mode</p>
            </div>
          </div>
          <div class="flex items-center justify-between p-4 rounded-xl bg-base-100/50">
            <span class="text-base font-medium">{{ isDark ? 'Dark Mode' : 'Light Mode' }}</span>
