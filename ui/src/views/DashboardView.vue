<template>
  <div class="p-3">
    ...
    <div class="mb-4">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-base-content/60 mt-1 text-sm">{{ t.dashboard.description }}</p>
        </div>
        <button class="btn btn-primary btn-sm gap-2" @click="refreshAll">
    ...
    <!-- Error State -->
    <div v-else-if="error" class="alert alert-error gap-2">
    ...
    <template v-else-if="clusters.length > 0">
      <!-- Stats Overview -->
      <div class="stats stats-vertical lg:stats-horizontal shadow w-full mb-4 glass-strong gradient-border">
        <div class="stat glass">
          ...
          <div class="stat-title text-xs">{{ t.dashboard.totalClusters }}</div>
          <div class="stat-value text-primary text-lg">{{ totalStats.totalClusters }}</div>
          <div class="stat-desc text-xs">
            <span class="text-success">{{ totalStats.healthyClusters }} {{ t.dashboard.healthyClusters }}</span>
            <span v-if="totalStats.totalClusters - totalStats.healthyClusters > 0" class="text-error ml-1">
        ...
        <div class="stat glass">
          ...
          <div class="stat-title text-xs">{{ t.dashboard.totalTopics }}</div>
          <div class="stat-value text-secondary text-lg">{{ totalStats.totalTopics }}</div>
          <div class="stat-desc text-xs">{{ t.dashboard.partitions }}/{{ t.dashboard.topics }} avg</div>
        </div>
        ...
        <div class="stat glass">
          ...
          <div class="stat-title text-xs">{{ t.dashboard.totalPartitions }}</div>
      ...
      <div class="mb-4">
        <div class="flex items-center justify-between mb-2">
          <h2 class="text-base font-semibold text-gradient">{{ t.dashboard.clusters }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          >
            <div class="card-body p-3">
              ...
              <div class="flex items-center justify-between mb-1">
                <div class="flex items-center gap-2">
                  ...
                  <div class="flex items-center gap-1.5">
                    <div
                      class="relative w-2.5 h-2.5 status-dot"
                    >
                      <span
                    ...
                    <span class="font-semibold text-sm text-gradient">{{ cluster.name }}</span>
                  </div>
                </div>
                <div
                  class="badge gap-1 badge-xs badge-primary"
              ...
              <!-- Card Body -->
              <div class="text-xs text-base-content/60 truncate mb-2">
                {{ cluster.brokers }}
              </div>
              ...
              <div class="card-actions justify-end mt-2 pt-2 border-t border-base-200">
                <router-link :to="`/topics?cluster=${cluster.name}`" class="btn btn-primary btn-xs gap-1">
    ...
    <div v-else class="flex flex-col items-center justify-center py-8 text-center">
      ...
      <p class="text-base-content/60 mb-4 text-sm">{{ t.clusters.description }}</p>
      <router-link to="/clusters" class="btn btn-primary btn-sm gap-2">
