<template>
  <div class="min-h-screen bg-base-100">
    <!-- Top Navigation Bar -->
    <header class="navbar glass border-b border-base-200 fixed top-0 left-0 right-0 h-10 z-50 px-2">
      <div class="flex-1 flex items-center gap-2">
        <!-- Logo and Brand -->
        <div class="flex items-center gap-1.5">
          <div class="w-6 h-6 rounded bg-primary flex items-center justify-center shadow-lg">
          ...
          <h1 class="text-base font-bold">Kafka Manager</h1>
        </div>
        ...
        <div class="relative">
          ...
          <div
            ...
            class="absolute top-full mt-1 w-72 bg-base-100 border border-base-200 rounded-lg shadow-xl z-50 max-h-96 overflow-y-auto"
          >
    ...
    <div class="flex h-screen pt-11 overflow-hidden p-2 gap-2">
