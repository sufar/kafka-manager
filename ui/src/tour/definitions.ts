...
const sidebarSteps: TourStep[] = [
  ...
  { selector: '[data-tour="navbar-schema-btn"]', title: 'tour.sidebarSchemaBtn.title', description: 'tour.sidebarSchemaBtn.desc', position: 'bottom' },
...
const treeSidebarSteps: TourStep[] = [
  ...
  { selector: '[data-tour="navbar-schema-btn"]', title: 'tour.treeSchemaBtn.title', description: 'tour.treeSchemaBtn.desc', position: 'bottom' },
