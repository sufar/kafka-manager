<template>
  <div>
    ...
    <div class="fixed top-4 right-4 toast toast-end z-[9999] pointer-events-none">
      <div v-for="toast in toasts" :key="toast.id" class="alert pointer-events-auto" :class="getToastClass(toast.type)">
